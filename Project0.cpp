...
int main() /* All code inside this function would be excuted first and given priority */
{
    ...
    // game engine like unreal use this language moreover it is use to make very fast programs
    ...
    // Basically most of the things i've learnt is similar to languages I have learnt in the past
